...
const HeroSection = () => {
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-purple-900/20 via-blue-900/10 to-transparent">
      {/* Animated Background */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-center lg:text-left">
          ...
          {/* Stats */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-2xl mx-auto lg:mx-0 animate-fade-in delay-700">
        ...
        {/* Right side - 3D Cube Scene */}
        <div className="relative h-[600px] lg:h-[700px] animate-fade-in delay-700">
          ...
          <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-center">
            <p className="text-sm text-purple-300 bg-black/20 px-4 py-2 rounded-full backdrop-blur-sm">
