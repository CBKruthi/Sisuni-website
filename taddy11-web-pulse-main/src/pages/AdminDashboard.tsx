...
//     const url = `${import.meta.env.VITE_API_BASE_URL}/api/applications` +
//       (userEmail !== 'admin' ? `?email=${encodeURIComponent(userEmail)}` : '');
...
//         const response = await axios.put(`${import.meta.env.VITE_API_BASE_URL}/api/jobs/${editingJob._id}`, jobData);
...
//       try {
//         const response = await axios.delete(`${import.meta.env.VITE_API_BASE_URL}/api/jobs/${jobId}`);
...
//                                         variant="outline"
//                                         size="sm"
//                                         onClick={() => window.open(`${import.meta.env.VITE_API_BASE_URL}/uploads/resumes/${selectedApplication.resumeFileName}`, '_blank')}
//                                         className="ml-2"
//                                       >
//                                         <Eye className="h-4 w-4 mr-2" />
//                                         View Resume
...
//                               variant="outline"
//                               size="sm"
//                               onClick={() => window.open(`${import.meta.env.VITE_API_BASE_URL}/uploads/resumes/${application.resumeFileName}`, '_blank')}
...
//   if (!value) setEditingJob(null); // Optional: reset editing state
// }}>
