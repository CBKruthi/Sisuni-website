...
//     const encodedEmail = encodeURIComponent(userEmail); // ✅ encode email
...
//         <div className="mb-10">
//           <h1 className="text-4xl font-bold text-purple-800 mb-10">My Applications</h1>
...
//               <Card key={application._id} className="border-purple-200 transition-all transform hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(168,85,247,0.3)]">
//                 <CardHeader className="pb-0">
//   <div className="flex justify-between items-center">
//     <CardTitle className="text-base text-purple-800">{application.preferredRole}</CardTitle>
